...
<?php
    ...
    if ( !$selectedLang || strlen($selectedLang) != 2 ) {
        header('Location: '. "index.html");
        exit();
    } else {
        require("lang/$selectedLang.php");
    }
?>
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/punctum.css?refresh=1" media="screen" charset="utf-8">
    </head>
    <body>
        <div id="fullpage">
            <div class="section" id="hello">
                <form id="frmDatosSujeto">
                    <ul>
                        <li>
                            <label><?= $lang["formName"] ?></label>
                            <input name="fullname" type="text" />
                        </li>
                        <li>
                            <label><?= $lang["formAge"] ?></label>
                        ...
                        <li>
                            <label><?= $lang["formNationality"] ?></label>
                        ...
                        <li>
                            <label><?= $lang["formEducation"] ?></label>
                            <select name="education">
                                <option></option>
                                <option><?= $lang["formEducation_1"] ?></option>
                                <option><?= $lang["formEducation_2"] ?></option>
                                <option><?= $lang["formEducation_3"] ?></option>
                ...
                <button id="btnStart"><?= $lang["formStart"] ?></button>
            </div>

            <div class="section" id="mainSection">
                <h2><?= $lang["instructions"] ?></h2>
                <button id="btnNext"><?= $lang["next"] ?></button>
            </div>
